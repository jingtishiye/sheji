...
if ($numuv==0){
	echo "<script>alert('预约设计师不存在！');history.go(-1);</script>";
	exit; 
}
...
<title>预约设计师<?php echo $arrayuv['relname']?></title>
...
<div class="main">
        <div class="yyitem">
            <div class="ititle">
                <h2>免费预约设计师<?php echo $arrayuv['relname']?></h2>
                <p>
                    (已有<?php echo mysql_num_rows(mysql_query("select id from  tb_uysj",$conn));?>人预约)</p>
            </div>
            <div class="clear">
            </div>
        ...
        else if(dtype == 0)
        {
            ...
            $(".errbox").attr("style", "border:solid 1px #16AD66");
                ...
                $.ajax({
                    ...
                    data: { "type": "yuesjs2", "OName": name, "OMobile": mobile, "OID": oid,"Community":community,"Square":square,"DType":dtype,"Price":price },
