...
if($id>0){
	...
	$rs=mysql_query("select * from tb_upl where uid=$arrayuv[id] and id='$id'",$conn);
...
<td  class="title3 font16" align="left">
	...
	$array5=mysql_fetch_array($rs5);
	?>				
	<a href="/gong/show.php?id=<?php echo $array5["id"]?>" target="_blank"><span  style="color:#006600;"><?php echo $array5["relname"]?></span>【详细】</a>
...
<td    class="title32"  ></td>
<td  class="title3 " align="left">
<input type="button" class="textsub" name="sub" value="返回列表" size="25"  onclick="window.location.href='yz_pl.php'"  />
