...
if($id>0){
	...
	$rs=mysql_query("select * from tb_uysj where uyid=$arrayuv[id] and id='$id'",$conn);
...
<td    class="title32"  ></td>
<td  class="title3 " align="left">
<input type="button" class="textsub" name="sub" value="返回列表" size="25"  onclick="window.location.href='sjs_yue.php'"  />
