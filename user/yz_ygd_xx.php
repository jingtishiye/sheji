...
<div class="clear"></div>
   <div class="pageRightWrap">
            <div class="pR_tit_w">
                <div class="pR_tit">已申请参观工地信息</div>
...
if($id>0){
	...
	$rs=mysql_query("select * from tb_uylf where uid=$arrayuv[id] and id='$id'",$conn);
...
<td  class="title3 " align="left">
 <?php
	...
	?>				
	<a href="/gongdi/show.php?id=<?php echo $array5["id"]?>" target="_blank"><span  style="color:#006600; font-size:16px;">【<?php echo $array5["title"]?>】</span></a>
...
<td    class="title32"  ></td>
<td  class="title3 " align="left">
<input type="button" class="textsub" name="sub" value="返回列表" size="25"  onclick="window.location.href='yz_ygd.php'"  />
