...
<div class="userCenter_wrapper">
  <div class="userCenter_location"> <a href="index_yz.php">业主个人中心</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="index_yz.php">业主信息</a>&nbsp;&nbsp;>&nbsp;&nbsp;<span>修改登录密码</span> </div>
<?php
include("yz_left.php");
?>
			...
			$.alertable.alert('确认密码和新密码不一致！！');
                ...
                $.ajax({
					...
					if(result == "1"){	 
					    ...
					    window.location.href='index_yz.php';  
