...
<div class="userCenter_wrapper">
  <div class="userCenter_location"> <a href="index_gz.php">工长个人中心</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="index_gz.php">工长信息</a>&nbsp;&nbsp;>&nbsp;&nbsp;<span>修改登录密码</span> </div>
<?php
$qhs=6;
include("gz_left.php");
?>
			...
			$.alertable.alert('确认密码和新密码不一致！！');
                ...
                $.ajax({
					...
					if(result == "1"){	 
					    ...
					    window.location.href='index_gz.php';  
