...
<div class="userCenter_wrapper">
  <div class="userCenter_location"> <a href="index_sjs.php">设计师个人中心</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="index_sjs.php">设计师信息</a>&nbsp;&nbsp;>&nbsp;&nbsp;<span>预约我的信息</span> </div>
<?php
$qhs=4;
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
				...
				<?php
				$xxrs=mysql_query("select * from tb_uysj where uyid=$arrayuv[id] order by  id desc ",$conn);
				$J=1;
 ...
 <?php echo substr($array['tel'],0,3)?>****<?php echo substr($array['tel'],7,4)?>
				    ...
				    <td class="td"><input type="button" name="Submit3" value="查看" onclick="window.location.href='sjs_yue_xx.php?id=<?php echo $array["id"]?>' "  class="btn"/> </td>
				</tr>
				<?php
				$J++;
				 endwhile;
