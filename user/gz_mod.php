...
<div class="userCenter_wrapper">
  <div class="userCenter_location"> <a href="index_gz.php">工长个人中心</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="index_gz.php">工长信息</a>&nbsp;&nbsp;>&nbsp;&nbsp;<span>工长基本资料</span> </div>
<?php
$qhs=1;
include("gz_left.php");
?>
            ...
            <div class="pR_content_w">
                <div style="padding:24px 0;">
                  <form method="post" action="chuli.php" class="userCenterFrom J_ajaxForm"  name="form1" enctype="multipart/form-data"  onSubmit="return checkform();">
                   <input name="type"  type="hidden"   value="modgz" />
...
<div class="lineW clear">
                            <div class="names">工种:</div>
                            
<label class="rad_label"><input type="radio" class="rad sex" name="jiguan" value="设计师" <?php if ($array['jiguan']=="设计师") echo "checked"?>  >&nbsp;&nbsp;设计师&nbsp;&nbsp;</label>                         
                            
<label class="rad_label"><input type="radio" class="rad sex" name="jiguan" value="瓦工" <?php if ($arrayuv['jiguan']=='瓦工') echo "checked"?>>&nbsp;&nbsp;瓦工&nbsp;&nbsp;</label>
<label class="rad_label"><input type="radio" class="rad sex" name="jiguan" value="水电工" <?php if ($arrayuv['jiguan']=='水电工') echo "checked"?>>&nbsp;&nbsp;水电工&nbsp;&nbsp;</label>
<label class="rad_label"><input type="radio" class="rad sex" name="jiguan" value="油漆工" <?php if ($arrayuv['jiguan']=='油漆工') echo "checked"?>>&nbsp;&nbsp;油漆工&nbsp;&nbsp;</label>
<label class="rad_label"><input type="radio" class="rad sex" name="jiguan" value="木工" <?php if ($arrayuv['jiguan']=='木工') echo "checked"?>>&nbsp;&nbsp;木工&nbsp;&nbsp;</label>
          ...
          <div class="lineW clear">
              ...
              <input type="text" class="inp3 qq" name="glid" value="<?php echo $arrayuv["glid"]?>">年
                        ...
                        <div class="lineW clear">
                           ...
                           <div class="lineW clear">
                            <div class="names">接单区域:</div>
 
  <input type="text" class="inp2 qq" name="jquyu" id="textbox"  value="<?php echo $arrayuv["jquyu"]?>">
