...
<title><?php echo $zsname?>_工长会员中心</title>
...
<div class="grens"> 
<a href="/user/index_gz.php" ><?php if ($jbids==0){?>
工长中心
<?php }elseif ($jbids==1){?>
设计师中心
<?php }elseif ($jbids==2){?>
...
<?php if ($userid>0){?>
<img src="images/online_member.gif" width="13" /> <span class="hongs"><a href="/user/" ><?php echo $arrayuv['relname']?></a></span>， <a href="/user/index_gz.php" >进入工长中心</a><br /><a href="/user/logout.php">安全退出</a>
