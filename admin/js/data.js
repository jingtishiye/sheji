  ...
  for(i=0;i<t.rows[0].cells.length;i++){
   var std=event.srcElement;
   if(std==t.rows[0].cells[i]){
    showRow=i+1;
    event.srcElement.className="bottom";
   }else{
    t.rows[0].cells[i].className="btmline"; 
   }
  }
  //显示 恰当的行并改变样式
  for(i=1;i<t.rows.length;i++){
   if(i==showRow){
    ...
    for(j=0;j<t.rows[i].cells.length;j++){
     t.rows[i].cells[j].className="top"; 
    }
   }else{
  ...
  for(i=0;i<t.rows[0].cells.length;i++){
   ...
   if(std==t.rows[0].cells[i]){
    showRow=i+1;
    event.srcElement.className="bottom2";
   }else{
    t.rows[0].cells[i].className="btmline"; 
   }
  }
