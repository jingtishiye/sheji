...
$rsuv=mysql_query("select id,xqus from xingxis where id=$id ",$conn);
$numuv=mysql_num_rows($rsuv);
$arrayuv=mysql_fetch_array($rsuv); 

if ($numuv==0){
	echo "<script>alert('预约参观的工地不存在！');history.go(-1);</script>";
	exit; 
}
...
<title>预约工地<?php echo $arrayuv['xqus']?></title>
...
<div class="main">
        <div class="yyitem">
            <div class="ititle">
                <h2>免费参观工地<?php echo $arrayuv['xqus']?></h2>
                <p>
            ...
            <div class="ibox">
                ...
                <div class="box-1 input" style="width: 31%">
                    <input placeholder="请输入手机号码" type="text" id="Mobile" name="Square" onKeyUp="value=value.replace(/[^\d]/g,'')"  maxlength="11" class="form-control" />
                </div>
            </div>
            <div class="ibox">
                <label>
            ...
            <div class="ibox">
                <div class="box-2 input">
                    ...
                    <input type="button" value="立即预约" class="form-btnsub" id="form-btnsub" onclick="yuegd()" />
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function yuegd() {
        ...
        if (name.length == 0) {
            ...
            $(".errbox").attr("style", "border:solid 1px #f94c07");
        ...
        else if(dtype == 0)
        {
            ...
            $(".errbox").attr("style", "border:solid 1px #f94c07");
                ...
                $.ajax({
                    ...
                    data: { "type": "yuegd", "OName": name, "OMobile": mobile, "OID": oid,"Community":community,"Square":square,"DType":dtype,"Price":price },
